...
\begin{tikzpicture}
\draw[thick, ->] (1,0) -- (9,0);
\draw[thick, ->] (1,-0.5) -- (9,-0.5);
\draw[thick, ->] (1,-1) -- (9,-1);
\filldraw (10.5, 0) node{$x^2 + 9x + 18 \geq 0$};
\filldraw (10, -0.5) node{$2-x > 0$};
\filldraw (10, -1) node{$f(x) \geq 0$};
\filldraw (3,0) circle (2pt) node[anchor=south]{-6};
\filldraw (2,0) node[anchor=north]{+};
\filldraw (5,0) circle (2pt) node[anchor=south]{-3};
\filldraw (4,0) node[anchor=north]{-};
\filldraw (7,0) circle (2pt) node[anchor=south]{0};
\filldraw (6,0) node[anchor=north]{+};
\filldraw (8,-1) node[anchor=north]{$\not\exists x$};
\filldraw (2,-0.5) node[anchor=north]{+};
\filldraw (4,-0.5) node[anchor=north]{+};
\filldraw (6,-0.5) node[anchor=north]{+};
\filldraw (2,-1) node[anchor=north]{+};
\filldraw (4,-1) node[anchor=north]{-};
\filldraw (6,-1) node[anchor=north]{+};
\end{tikzpicture}
\\\\
...
\draw[thick, ->] (1,-0.5) -- (9,-0.5);
\draw[thick, ->] (1,-1) -- (9,-1);
\filldraw (10.5, 0) node{$x^2-4x-36 \leq 0$};
\filldraw (10.5, -0.5) node{$(2-x)^2 > 0$};
\filldraw (10, -1) node{$f(x) \geq 0$};
\filldraw (2,0) node[anchor=north]{-};
\filldraw (4,0) node[anchor=north]{+};
\filldraw (2,-0.5) node[anchor=north]{+};
...
\draw[thick, ->] (1,0) -- (11,0);
\draw[thick, ->] (1,-0.5) -- (11,-0.5);
\draw[thick, ->] (1,-1) -- (11,-1);
\filldraw (12.5, 0) node{$x^2-9x+18 \geq 0$};
\filldraw (12, -0.5) node{$2-x > 0$};
\filldraw (12, -1) node{$f(x) \geq 0$};
\filldraw (4,0) node[anchor=north]{+};
\filldraw (6,0) node[anchor=north]{+};
\filldraw (8,0) node[anchor=north]{-};
\filldraw (10,0) node[anchor=north]{+};

\filldraw (4,-0.5) node[anchor=north]{+};
\filldraw (6,-0.5) node[anchor=north]{-};
\filldraw (8,-0.5) node[anchor=north]{-};
\filldraw (10,-0.5) node[anchor=north]{-};

\filldraw (4,-1) node[anchor=north]{+};
\filldraw (6,-1) node[anchor=north]{-};
\filldraw (8,-1) node[anchor=north]{+};
\filldraw (10,-1) node[anchor=north]{-};

\filldraw (3,0) circle (2pt) node[anchor=south]{0};
\filldraw (2,-1) node[anchor=north]{$\not\exists x$};
\filldraw (5,0) circle (2pt) node[anchor=south]{2};
\filldraw (7,0) circle (2pt) node[anchor=south]{3};
\filldraw (9,0) circle (2pt) node[anchor=south]{6};
\end{tikzpicture}
\\\\
...
\begin{tikzpicture}
\draw[thick, ->] (1,0) -- (8,0);
\draw[thick, ->] (1,-0.5) -- (8,-0.5);
\draw[thick, ->] (1,-1) -- (8,-1);
\filldraw (11, 0) node{$x^2 - 4x \leq 0$};
\filldraw (11, -0.5) node{$(2-x)^2 > 0$};
\filldraw (11, -1) node{$f(x) \geq 0$};
\filldraw (3,0) node[anchor=north]{+};
\filldraw (5,0) node[anchor=north]{+};
\filldraw (7,0) node[anchor=north]{-};
\filldraw (3,-0.5) node[anchor=north]{+};
\filldraw (5,-0.5) node[anchor=north]{+};
\filldraw (7,-0.5) node[anchor=north]{+};
\filldraw (3,-1) node[anchor=north]{+};
\filldraw (5,-1) node[anchor=north]{+};
\filldraw (7,-1) node[anchor=north]{-};
\filldraw (2,0) circle (2pt) node[anchor=south]{0};
\filldraw (1,-1) node[anchor=north]{$\not\exists x$};
...
= \frac{8}{(2-x)^3}
\]
della quale, calcolando il segno banalmente vale,
\\\\
\begin{tikzpicture}
\draw[thick, ->] (1,0) -- (8,0);
\draw[thick, ->] (1,-0.5) -- (8,-0.5);
\draw[thick, ->] (1,-1) -- (8,-1);
\filldraw (10, 0) node{$8 \geq 0$};
\filldraw (10, -0.5) node{$(2-x)^3 > 0$};
\filldraw (10, -1) node{$f(x) \geq 0$};
\filldraw (2,-1) node[anchor=north]{$\not\exists x$};
\filldraw (4,0) node[anchor=north]{+};
\filldraw (6,0) node[anchor=north]{+};
